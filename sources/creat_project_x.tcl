...
ipgui::move_param -component [ipx::current_core] -order 0 [ipgui::get_guiparamspec -name "dds_channel" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]
ipgui::move_param -component [ipx::current_core] -order 1 [ipgui::get_guiparamspec -name "pinc_width" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]
ipgui::move_param -component [ipx::current_core] -order 2 [ipgui::get_guiparamspec -name "data_width" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]

set_property widget {textEdit} [ipgui::get_guiparamspec -name "dds_channel" -component [ipx::current_core] ]
set_property tooltip {DDS parallelism.} [ipgui::get_guiparamspec -name "dds_channel" -component [ipx::current_core] ]
set_property widget {textEdit} [ipgui::get_guiparamspec -name "pinc_width" -component [ipx::current_core] ]
set_property tooltip {The phase increment control word bit width set in the DDS IP core.} [ipgui::get_guiparamspec -name "pinc_width" -component [ipx::current_core] ]
set_property widget {textEdit} [ipgui::get_guiparamspec -name "data_width" -component [ipx::current_core] ]
set_property tooltip {The signal output bit width set in the DDS IP core.} [ipgui::get_guiparamspec -name "data_width" -component [ipx::current_core] ]
